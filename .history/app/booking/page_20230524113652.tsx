"use client";
Mis disculpas por la confusión anterior. A continuación se muestra el código actualizado del componente `Booking` que cumple con tus requisitos:
...
Este código implementa el formulario de reserva con todos los componentes necesarios. Al hacer clic en el botón "Submit", los datos se guardan en el localStorage y se muestra un párrafo con los datos guardados en la parte superior de la página.

Asegúrate de tener los componentes `BookingHours`, `Date