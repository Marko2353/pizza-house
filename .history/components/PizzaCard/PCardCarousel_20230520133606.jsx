...
export default function PCardCarousel() {
  ...
  return (
    <section className="container py-10 m-auto bg-dark">
      ...
      <p className="flex text-center my-5 w-[60ch] text-light">Lorem ipsum dolor sit amet consectetur. Consectetur donec maecenas nisl pellentesque amet non. Pellentesque aliquam</p>
