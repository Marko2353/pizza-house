  ...
  return (
    <section className="py-10 m-auto bg-dark">
      ...
      <div className="container relative w-2/4 mx-auto">
        <button
          className="absolute left-0 p-2 transform -translate-y-1/2 rounded-full top-1/2 bg-dark hover:bg-gray-400 focus:outline-none"
        ...
        <button
          className="absolute right-0 p-2 transform -translate-y-1/2 rounded-full top-1/2 bg-dark hover:bg-gray-400 focus:outline-none"
