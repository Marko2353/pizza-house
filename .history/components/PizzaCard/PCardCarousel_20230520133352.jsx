...
export default function PCardCarousel() {
  ...
  return (
    <section className="py-10 bg-dark">
      ...
      <p className="text-center my-5 w-[60ch]">Lorem ipsum dolor sit amet consectetur. Consectetur donec maecenas nisl pellentesque amet non. Pellentesque aliquam</p>
