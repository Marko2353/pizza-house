...
export default function PCardCarousel() {
  ...
  return (
    <section className="py-10 bg-dark">
      ...
      <p className="text-center  w-[60ch] text-light">Lorem ipsum dolor sit amet consectetur. Consectetur donec maecenas nisl pellentesque amet non. Pellentesque aliquam</p>
