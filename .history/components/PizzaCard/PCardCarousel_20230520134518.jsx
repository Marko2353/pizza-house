  ...
  return (
    <section className="container py-10 m-auto bg-dark">
      ...
      <div className="container relative w-2/4 mx-auto overflow-hide">
        ...
        <div className="absolute transform -translate-y-1/2 top-1/2 left-4 overflow-hide">
          <button
        ...
        <div className="absolute transform -translate-y-1/2 top-1/2 right-4 overflow-hide">
          <button
            className="p-2 bg-gray-300 rounded-full hover:bg-gray-400 focus:outline-none"
