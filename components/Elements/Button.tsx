const getVariant = (variant?: VariantType) => {
  switch (variant) {
    case "primary":
      return "bg-primary hover:bg-violet-700  text-white shadow shadow-violet-600/25 hover:shadow-violet-600/75";
    case "danger":
    ...
    default:
      return "bg-primary hover:bg-primaryHover text-light uppercase box-shadow";
  }
};
...
export const Button = ({
  ...
  return (
    <button
      ...
      }  ${!square && "rounded-xl"} active:scale-95 ${className} `}
    >
      {children}
    </button>
  );
